...
class DiscussPageExpanded extends StatefulWidget {
  final String folderName;
  final String teacherUid;
  const DiscussPageExpanded(
      {super.key, required this.teacherUid, required this.folderName});

  @override
  _DiscussPageExpandedState createState() => _DiscussPageExpandedState();
}

class _DiscussPageExpandedState extends State<DiscussPageExpanded> {
